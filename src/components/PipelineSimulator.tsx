...
export function PipelineSimulator() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 rounded-2xl border border-slate-200/80 bg-white/70 p-6 backdrop-blur-md shadow-sm">
        ...
        <textarea
          ...
          className="mt-2 w-full rounded-xl border border-slate-200 bg-white p-3.5 font-mono text-xs text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-inner"
        />

        <div className="mt-4 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200/70 pt-4 text-xs font-medium">
          ...
          return (
            <div
              ...
              className={`relative overflow-hidden rounded-2xl p-4 transition-all border ${
                isActive
                  ? "bg-white border-indigo-500 shadow-lg shadow-indigo-500/10 scale-105"
                  : isDone
                    ? "bg-white/90 border-emerald-200 text-slate-900 shadow-sm"
            ...
            >
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                  isDone ? "bg-emerald-100 text-emerald-800" : isActive ? "bg-indigo-600 text-white" : "bg-slate-200 text-slate-600"
                }`}>
      ...
      {(currentStep > 0 || completed) && (
        <motion.div
          ...
          className="mt-6 rounded-2xl border border-slate-200/80 bg-white/90 p-6 backdrop-blur-md shadow-sm"
        >
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            ...
            <span className="badge-glass text-indigo-700">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3 font-mono">
            ...
            {currentStep >= 1 && (
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-1 text-xs text-slate-900 bg-white p-2.5 rounded-lg border border-slate-200 italic">
                  "{activeInputText}"
                </p>
              </div>
            )}
            ...
            {currentStep >= 2 && (
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-1 text-xs text-slate-900 bg-white p-2.5 rounded-lg border border-slate-200">
            ...
            {currentStep >= 3 && (
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-1 space-y-1 text-xs text-slate-900 bg-white p-2.5 rounded-lg border border-slate-200">
            ...
            {currentStep >= 5 && (
              <div className="rounded-xl border border-red-200 bg-gradient-to-br from-red-500 to-rose-600 text-white p-4 md:col-span-2 lg:col-span-2 shadow-lg shadow-red-500/20">
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2 text-slate-900">
                  <div className="bg-white/95 p-3.5 rounded-xl border border-white">
