...
export function PipelineSimulator() {
  ...
  return (
    <section
      ...
      className="card-light scroll-mt-24 p-6 md:p-10"
    >
      ...
      <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50/80 p-6">
        ...
        <textarea
          ...
          className="mt-2 w-full rounded-lg border border-slate-200 bg-white p-3.5 font-mono text-xs text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-600 shadow-sm"
        />
      ...
      {(currentStep > 0 || completed) && (
        <motion.div
          ...
          className="mt-6 rounded-xl border border-slate-200 bg-slate-50/90 p-6 shadow-sm"
        >
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            ...
            <span className="badge-light text-blue-700">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3 font-mono">
            ...
            {currentStep >= 1 && (
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                <p className="mt-1 text-xs text-slate-900 bg-slate-50 p-2.5 rounded-md border border-slate-200 italic">
                  "{activeInputText}"
                </p>
              </div>
            )}
            ...
            {currentStep >= 2 && (
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                <p className="mt-1 text-xs text-slate-900 bg-slate-50 p-2.5 rounded-md border border-slate-200">
            ...
            {currentStep >= 3 && (
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                <ul className="mt-1 space-y-1 text-xs text-slate-900 bg-slate-50 p-2.5 rounded-md border border-slate-200">
            ...
            {currentStep >= 5 && (
              <div className="rounded-lg border border-red-200 bg-red-600 text-white p-4 md:col-span-2 lg:col-span-2 shadow-md">
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2 text-slate-900">
                  <div className="bg-white p-3.5 rounded-md border border-white">
